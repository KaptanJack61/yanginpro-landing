...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-red-900 relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-white font-medium">+90 (850) 123 45 67</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Projeleriniz hakkında kısaca bilgi verin..."
                  />
                </div>
